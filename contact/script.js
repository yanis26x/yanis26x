...
const i18n = {
  fr: {
    ...
    heroText: "<b>@yanis26x</b> = mon username sur <b>toutes</b> les plateformes.<br />Je répond <b>plus rapidement sur Instagram</b>",
    followMe: "Me suivre",
    copyEmailBtn: "Copier mon email",
    followTitle: "Follow",
    followSub: "Tout est ici",
    igSub: "@yanis26x · (réponse + rapide)",
    liSub: "Yanis Djenadi",
  ...
  en: {
    back: "Back",
    contactTitle: "Contact",
    heroText: "<b>@yanis26x</b> = my username on <b>every</b> platform.<br />I reply <b>faster on Instagram</b>",
    followMe: "Follow me",
    copyEmailBtn: "Copy my email",
    followTitle: "Follow",
    followSub: "Everything is here",
    igSub: "@yanis26x · (faster replies)",
    liSub: "Yanis Djenadi",
